...
authentification();
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['Makamesco-Md', "safari", "1.0.0"],
...
setInterval(async () => {
    if (conf.AUTO_BIO === "yes") {
        ...
        const bioText = `💬 Makamesco Md is active...\n${currentDateTime}`; // Format the bio text
...
function createNotification(deletedMessage) {
    ...
    let notification = `*[ 💡MAKAMESCO MD ANTIDELETE💡 ]*\n\n`;
...
if (conf.AUDIO_REPLY === "yes") {
    console.log(Makamesco md AUTO_REPLY_AUDIO is enabled. Listening for messages...");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://files.catbox.moe/sigghy.jpg';
    }
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("♻️ makamesco md is connecting...");
            }
            else if (connection === 'open') {
                console.log("makamesco md Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("👀 makamesco md is Online 🕸\n\n");
                //chargement des luckycmd 
                console.log("🛒 Loading makamesco md Plugins...\n");
