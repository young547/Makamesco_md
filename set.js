...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254710155765",  
    ...
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By Eliakim Md',   
    ...
    CAPTION : process.env.CAPTION || "ELIAKIM_MD",
